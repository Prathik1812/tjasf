...
SELECT v.id, 1, 'Inaugural Issue', '2026-01-15', false
...
INSERT INTO policies (slug, title, category, content) VALUES
  ...
  ('article-processing-charges', 'Article Processing Charges', 'Fees', '### Publication & Submission Fees\n\nTJASF is committed to transparent, open-access scientific publishing. Below is the complete breakdown of submission options and article processing charges:\n\n| Submission Track | Review Duration | Article Processing Charge (APC) | Launch Offer Status |\n| --- | --- | --- | --- |\n| **Regular Track** | Standard (12–16 weeks) | **$0 USD (Free)** | **FREE** |\n| **Fast-Track Review** | Expedited (4–8 weeks) | **$49 USD** | **FREE (First 2 Issues)** |\n| **Low-Income Country Waiver** | Standard (12–16 weeks) | **$0 USD (Free)** | **FREE** |\n\n---\n\n### Special Launch Offer\nTo celebrate the official launch of **The Journal of Advanced Scientific Frontiers (TJASF)**, all manuscript submissions accepted for publication in the **first two inaugural issues (Volume 1, Issues 1 & 2)** will be published **100% free of cost** with zero Article Processing Charges (APCs) across both Regular and Fast-Track options.\n\n---\n\n### Key Policy Terms\n* **No Hidden Fees**: There are no submission fees, color charges, or page length surcharges.\n* **Copyright & License**: Authors retain full copyright of their work under the **Creative Commons Attribution License (CC BY 4.0)**.\n* **Waiver Policy**: TJASF provides 100% fee waivers for authors from low- and middle-income countries.') ,
