...
INSERT INTO policies (slug, title, category, content) VALUES
  ...
  ('article-processing-charges', 'Article Processing Charges', 'Fees', 'TJASF offers two submission tracks: Regular Track (completely free of charge with standard 12-16 week review) and Fast-Track ($49 USD fee for expedited 4-8 week peer review). However, to celebrate the official launch of TJASF, publication in the first 2 inaugural issues (Volume 1, Issues 1 & 2) is completely free of cost for all accepted manuscripts across both tracks!') ,
