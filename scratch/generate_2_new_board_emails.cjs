...
const members = [
  {
    ...
    filename: 'prof_ali_wagdy_mohamed.html'
  },
  {
    name: 'Dr. Panneerselvam Ponnusamy',
    email: 'pponnusamy@swin.edu.au',
    filename: 'dr_panneer_selvam_ponnusamy.html'
  }
];
...
console.log("All 2 new Editorial Board HTML templates generated successfully!");
