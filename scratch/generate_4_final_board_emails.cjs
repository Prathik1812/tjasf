...
function generateHtml(name, email) {
  ...
  <div style="padding: 32px 24px; background-color: #ffffff;">
    ...
    <p>Thank you for your interest in serving on the International Editorial Board of <strong>The Journal of Advanced Scientific Frontiers (TJASF)</strong>.</p>

    <p>After carefully reviewing your academic profile and research credentials, we are pleased to inform you that you have been appointed as an <strong>Editorial Board Member</strong> of TJASF.</p>

    <p>Your expertise and scholarly contributions will play an important role in maintaining the journal's academic quality, integrity, and international standards. We are delighted to welcome you to our growing global editorial community.</p>
    ...
    <p>To complete your onboarding process, please click the button below to activate your Editorial Board account:</p>
    
    <!-- Sign In / Activate Button -->
    ...
    <p style="font-size: 14px; color: #102342; font-weight: bold; margin-bottom: 8px;">Once your account is activated, you will be able to:</p>
    ...
    <p style="font-size: 13px; color: #667082; margin: 0; line-height: 1.6;">Warm regards,<br /><br />
      <strong style="color: #102342; font-size: 14px;">Dr. Rajesh Thumma</strong><br />
      <span style="color: #102342;">Founder &amp; Editor-in-Chief</span><br />
