...
const genericTemplate = generateHtml('{{MEMBER_NAME}}', '{{MEMBER_EMAIL}}');
fs.writeFileSync(path.join(__dirname, 'associate_editor_appointment_template.html'), genericTemplate, 'utf8');

console.log("All Editorial Board Member HTML files regenerated successfully!");
