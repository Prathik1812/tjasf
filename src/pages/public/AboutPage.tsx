  ...
  return (
    <div className="max-w-[900px] mx-auto px-8 py-20">
      ...
      <div className="prose prose-lg max-w-none text-[#27334a] leading-[1.7] space-y-6">
        ...
        <p className="whitespace-pre-line">
          {content.about_indexing || 'TJASF is committed to achieving broad indexing coverage. We are working toward inclusion in major databases including Scopus, Web of Science, and DOAJ.'}
        </p>
      </div>
    </div>
  );
